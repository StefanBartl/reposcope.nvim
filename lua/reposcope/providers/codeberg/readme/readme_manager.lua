---@module 'reposcope.providers.codeberg.readme.readme_manager'
...
---@class CodebergReadmeManager : ReadmeManagerModule
local M = {}
...
local readme_fetch_api = require("reposcope.providers.codeberg.readme.readme_fetcher").fetch_api
local readme_fetch_raw = require("reposcope.providers.codeberg.readme.readme_fetcher").fetch_raw
...
function M.prefetch(repo)
  ...
  local urls = require("reposcope.providers.codeberg.readme.readme_urls").get_urls(owner, repo_name, branch)
