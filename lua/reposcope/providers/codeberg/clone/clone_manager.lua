...
---@brief Coordinates cloning operations for Codeberg repositories.
---@description
...
---@class CodebergCloneManager : CloneManagerModule
local M = {}
...
local build_command = require("reposcope.providers.codeberg.clone.clone_command").build_command
