---@module 'reposcope.providers.codeberg.repositories.repository_manager'
---@brief Coordinates repository fetching and UI update after search.
---@description
---This module combines the logic of fetching repositories from Codeberg
...
---@class CodebergRepositoryManager : RepositoryManagerModule
local M = {}

-- Submodules
local fetcher = require("reposcope.providers.codeberg.repositories.repository_fetcher")
