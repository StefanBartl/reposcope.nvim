---@module 'reposcope.providers.gitlab.readme.readme_manager'
...
---@class GitlabReadmeManager : ReadmeManagerModule
local M = {}
...
local readme_fetch_api = require("reposcope.providers.gitlab.readme.readme_fetcher").fetch_api
local readme_fetch_raw = require("reposcope.providers.gitlab.readme.readme_fetcher").fetch_raw
...
---@param uuid string
---@return nil
---@see reposcope.providers.codeberg.readme.readme_manager.M.fetch_for_selected, reposcope.providers.github.readme.readme_manager.M.fetch_for_selected
function M.fetch_for_selected(uuid)
  ...
  readme_fetch_raw(owner, repo_name, branch, function(success, content, err)
    if success and content then
      ...
      _fetch_from_api_fallback(owner, repo_name, branch, uuid, repo.updated_at)
    end
  end)
end
