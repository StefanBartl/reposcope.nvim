...
---@field increase_success fun(uuid: string, query: string, source: string, context: string, duration_ms: number, status_code: number, url?: string) Increases the succes request count and logs it
---@field increase_failed fun(uuid: string, query: string, source: string, context: string, duration_ms: number, status_code: number, error?: string|nil, url?: string): nil Increases the failed request count and logs it
---@field increase_cache_hit fun(uuid: string, query: string, source: string, context: string, url?: string): nil Increases the cache hit count and logs it
---@field increase_fcache_hit fun(uuid: string, query: string, source: string, context: string, url?: string): nil Increases the filecache hit count and logs it
