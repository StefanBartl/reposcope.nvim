...
---@class RepoActionsModule Single-repository git push/pull/fetch/update, triggered interactively
...
---@field update fun(repo: string, on_done: fun(ok: boolean, err: string|nil): nil): nil
