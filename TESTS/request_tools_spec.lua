...
return function(H)
  ...
  do
    ...
    H.with_stubs({
      ...
      H.eq(argv[5], "--max-filesize", "SEC-21's byte cap is passed as a flag")
      H.eq(argv[6], "20971520", "20 MiB")
      H.eq(argv[7], "https://api.github.com/search/repositories?q=x", "the URL is the last argument, unmodified")
      H.eq(#argv, 7, "no headers means no further arguments")
